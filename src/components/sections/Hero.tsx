  ...
  return (
    <section ref={sectionRef} className="scroll-animation relative">
      ...
      >
        ...
        >
          <EyebrowBadge>CO-FOUNDER @ KATALYX SOLUTIONS</EyebrowBadge>
          <h1 className="max-w-[14ch] font-sans text-5xl font-semibold leading-[0.95] tracking-tighter text-foreground md:text-7xl lg:text-8xl">
            I am
            <br />
            <span className="text-accent">Yash Gupta.</span>
          </h1>
          <p className="max-w-[42ch] font-sans text-sm leading-relaxed text-zinc-400 md:text-base">
            Building digital experiences, solutions, applications, and products. Full-Stack Developer crafting modern web and Android apps with clean design, seamless performance, and real-world impact.
          </p>
        </div>
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-10">
          ...
          <div className="mx-6 flex items-center justify-between pb-4 font-mono text-[10px] uppercase tracking-[0.28em] text-zinc-500 md:mx-10">
            ...
            <span>PORTFOLIO // YASH GUPTA</span>
        ...
        {!loaded && (
          <div className="absolute inset-0 z-30 flex flex-col items-center justify-center gap-5 bg-background px-6">
            <EyebrowBadge>PORTFOLIO // INITIALIZING</EyebrowBadge>
            ...
            <p className="font-mono text-[11px] uppercase tracking-[0.28em] text-zinc-500">
              Loading Assets &nbsp;&middot;&nbsp; {Math.round(loadProgress * 100)}%
            </p>
          </div>
        )}
      </div>
